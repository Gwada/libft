...
t_list	*ft_lstnew(void const *content, size_t content_size);		: ok
void	ft_lstdelone(t_list **alst, void (*del)(void *, size_t));	: ok
void	ft_lstdel(t_list **alst, void (*del)(void *, size_t));		: ok
void	ft_lstadd(t_list **alst, t_list *new);				: ok
void	ft_lstiter(t_list *lst, void (*f)(t_list *elem));		: ok
